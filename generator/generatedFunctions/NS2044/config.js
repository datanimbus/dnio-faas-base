...
const temp = {
  ...
  dataStackFunctionId: process.env.DATA_STACK_FUNCTION_ID,
  dataStackFunctionVersion: process.env.DATA_STACK_FUNCTION_VERSION,
  dataStackFunctionName: process.env.DATA_STACK_FUNCTION_NAME,
  ...
  configDB: process.env.MONGO_AUTHOR_DBNAME || 'odpConfig',
  logsDB: process.env.MONGO_LOGS_DBNAME || 'odpLogs',
  mongoAuthorOptions: {
