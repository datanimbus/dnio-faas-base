...
const startLogger = log4js.getLogger('Init');
startLogger.level = config.logLevel;
global.loggerName = 'Init';
startLogger.info('Faas ID :: ', config.faasId);
...
(async () => {
  try {
    ...
    startLogger.error(`Error during initialization`);
    startLogger.error(err);
  }
